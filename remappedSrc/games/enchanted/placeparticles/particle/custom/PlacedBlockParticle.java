...
public class PlacedBlockParticle
  ...
  PlacedBlockParticle(ClientWorld world, double x, double y, double z, BlockState state) {
    super(world, x, y, z);
    ...
    this.rotationDirection = (float) ((Math.random() * (2 - -2)) + -2);
  }
  ...
  public static class Factory implements ParticleFactory<BlockStateParticleEffect> {
    ...
    public Particle createParticle(BlockStateParticleEffect blockStateParticleEffect, ClientWorld clientWorld, double d,
      ...
      return new PlacedBlockParticle(clientWorld, d, e, f, blockStateParticleEffect.getBlockState());
    }
